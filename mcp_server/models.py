...
#   timestamp: 2025-06-28T15:05:27+00:00
...
class CertificateParameters(BaseModel):
    ...
    RegistrationNo: str = Field(..., description='Registration No', examples=['0101-I'])
...
class PhcerCertificatePostRequest(BaseModel):
...
class PhcerCertificatePostResponse(BaseModel):
...
class PhcerCertificatePostResponse1(BaseModel):
...
class PhcerCertificatePostResponse2(BaseModel):
...
class PhcerCertificatePostResponse3(BaseModel):
...
class PhcerCertificatePostResponse4(BaseModel):
...
class PhcerCertificatePostResponse5(BaseModel):
...
class PhcerCertificatePostResponse6(BaseModel):
...
class CertificateParameters1(BaseModel):
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    RegistrationNo: str = Field(..., description='Registration No', examples=['1011-I'])


class RpcerCertificatePostRequest(BaseModel):
...
class RpcerCertificatePostResponse(BaseModel):
...
class RpcerCertificatePostResponse1(BaseModel):
...
class RpcerCertificatePostResponse2(BaseModel):
...
class RpcerCertificatePostResponse3(BaseModel):
...
class RpcerCertificatePostResponse4(BaseModel):
...
class RpcerCertificatePostResponse5(BaseModel):
...
class RpcerCertificatePostResponse6(BaseModel):
